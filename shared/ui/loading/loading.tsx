  ...
  return (
    <Svg width={31 * 7} height={7 * 7} fill="none" viewBox="0 0 775 175">
      ...
      <G transform={`rotate(${rotation} 675.414 113.414)`}>
        <Circle cx={675.414} cy={113.414} r={27.414} stroke="#fff" strokeWidth={4} />
        <Circle cx={675.834} cy={112.994} r={13.707} stroke="#fff" strokeWidth={2} />
        <Path
          stroke="#fff"
          strokeWidth={2}
      ...
      <G transform={`rotate(${rotation} 412.414 113.414)`}>
        <Circle cx={412.414} cy={113.414} r={27.414} stroke="#fff" strokeWidth={4} />
        <Circle cx={412.834} cy={112.994} r={13.707} stroke="#fff" strokeWidth={2} />
        <Path
          stroke="#fff"
          strokeWidth={2}
